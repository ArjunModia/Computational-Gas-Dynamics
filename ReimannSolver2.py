...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 14 12:22:08 2024
...
class RiemannSolver():
	...
	def set_state(self, rho_L, vx_L, P_L, rho_R, vx_R, P_R, gamma, t):
		...
		self.g1 = (gamma - 1.0) / (2.0*gamma) # g4
		self.g2 = (gamma + 1.0) / (2.0*gamma) # -g5
		self.g3 = 2.0 * gamma / (gamma - 1.0) # g7
		self.g4 = 2.0 / (gamma - 1.0) # g3
		self.g5 = 2.0 / (gamma + 1.0) # g1
		self.g6 = (gamma - 1.0) / (gamma + 1.0) # g2
		self.g7 = (gamma - 1.0) / 2.0 # g9 
		self.g8 = gamma - 1.0 # g8
		self.g9 = 1.0 / gamma # g6
